...
def venueadd():
    ...
    with cnx.cursor() as cursor:
        ...
        cursor.execute(''' Insert into VenueSlots2 (slot,datetime,venueid,availability,eventid) VALUES (1,'2019-08-01 08:00:00',%s,1,NULL);''',[venuei])
        cursor.execute(''' Insert into VenueSlots2 (slot,datetime,venueid,availability,eventid) VALUES (2,'2019-08-01 09:00:00',%s,1,NULL);''',[venuei])
        cursor.execute(''' Insert into VenueSlots2 (slot,datetime,venueid,availability,eventid) VALUES (3,'2019-08-01 10:00:00',%s,1,NULL);''',[venuei])
        cursor.execute(''' Insert into VenueSlots2 (slot,datetime,venueid,availability,eventid) VALUES (4,'2019-08-01 11:00:00',%s,1,NULL);''',[venuei])
        cursor.execute(''' Insert into VenueSlots2 (slot,datetime,venueid,availability,eventid) VALUES (5,'2019-08-01 12:00:00',%s,1,NULL);''',[venuei])
        cursor.execute(''' Insert into VenueSlots2 (slot,datetime,venueid,availability,eventid) VALUES (6,'2019-08-01 13:00:00',%s,1,NULL);''',[venuei])
        cursor.execute(''' Insert into VenueSlots2 (slot,datetime,venueid,availability,eventid) VALUES (1,'2019-08-02 08:00:00',%s,1,NULL);''',[venuei])
        cursor.execute(''' Insert into VenueSlots2 (slot,datetime,venueid,availability,eventid) VALUES (2,'2019-08-02 09:00:00',%s,1,NULL);''',[venuei])
        cursor.execute(''' Insert into VenueSlots2 (slot,datetime,venueid,availability,eventid) VALUES (3,'2019-08-02 10:00:00',%s,1,NULL);''',[venuei])
        cursor.execute(''' Insert into VenueSlots2 (slot,datetime,venueid,availability,eventid) VALUES (4,'2019-08-02 11:00:00',%s,1,NULL);''',[venuei])
        cursor.execute(''' Insert into VenueSlots2 (slot,datetime,venueid,availability,eventid) VALUES (5,'2019-08-02 12:00:00',%s,1,NULL);''',[venuei])
        cursor.execute(''' Insert into VenueSlots2 (slot,datetime,venueid,availability,eventid) VALUES (6,'2019-08-02 13:00:00',%s,1,NULL);''',[venuei])
        cursor.execute('''commit;''')
        return render_template('tadminhome.html')
